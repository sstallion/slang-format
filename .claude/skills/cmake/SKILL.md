...
- Use the `$TMPDIR` environment variable for temporary file creation.
...
- Log output to a temporary file named `$TMPDIR/cmake-generate.log`.
...
- Log output to a temporary file named `$TMPDIR/cmake-build.log`.
